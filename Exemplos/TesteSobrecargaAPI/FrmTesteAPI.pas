...
{OBS1: Componente open source usado para relizar requisições é o Request4Delphi
 disponível no link a seguir: https://github.com/viniciussanchez/RESTRequest4Delphi}

{OBS2: Este é apenas um exemplo, não foi realizado nenhum tipo de tratamento para erros,
 nem os possiveis tipos de requisições }
